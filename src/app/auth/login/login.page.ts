...
import { IonInputPasswordToggle, LoadingController, IonThumbnail, IonContent, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonRow, IonCol, IonGrid, IonInput, IonButton, IonIcon, IonToast, ToastController, IonLabel } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonInputPasswordToggle, IonThumbnail, IonLabel, IonIcon, IonButton, IonInput, IonGrid, IonCol, IonRow, IonCardContent, IonCardSubtitle, IonCardTitle, IonCardHeader, IonCard, IonContent, CommonModule, ReactiveFormsModule, IonToast]
})
